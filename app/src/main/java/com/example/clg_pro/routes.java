...
public class routes extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.item1:
                intent=new Intent(routes.this,menu.class);
                startActivity(intent);
                return true;
            case R.id.item2:
                intent=new Intent(routes.this,books.class);
                startActivity(intent);
                return true;
            case R.id.item3:
                intent=new Intent(routes.this,routes.class);
                startActivity(intent);
                return true;
            case R.id.item4:
            ...
            case R.id.item5:
                ...
                return true;
            case R.id.item6:
                Intent mainIntent = new Intent(routes.this , recruiting.class);
                startActivity(mainIntent);
                return true;
            case R.id.item7:
                intent=new Intent(routes.this,about_us.class);
                startActivity(intent);
                return true;
            default:
